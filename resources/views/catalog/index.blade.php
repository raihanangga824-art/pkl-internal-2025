...
<div class="container py-4">
    <div class="row">
        ...
        <div class="d-lg-none mb-3">
            <button class="btn btn-outline-primary w-100" type="button" data-bs-toggle="collapse" data-bs-target="#mobile-filter" aria-expanded="false" aria-controls="mobile-filter">
        ...
        <aside class="col-lg-3 mb-4">
            <div class="collapse d-lg-block" id="mobile-filter">
                    ...
                    <div class="card-body">
                        <form action="{{ route('catalog.index') }}" method="GET" id="filter-form">
                            ...
                            @if(request()->hasAny(['category', 'min_price', 'max_price', 'on_sale']))
                                <a href="{{ route('catalog.index') }}" class="btn btn-sm btn-outline-secondary w-100 mt-2">
